...
class AosExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function collection()
    {
        ...
        foreach ($this->reportData as $period => $metrics) {
            $data->push([
                'Period' => $period,
                'A/C In Fleet' => number_format($metrics['acInFleet'], 2),
                'A/C In Service' => number_format($metrics['acInService'], 2),
                'A/C Days In Service' => number_format($metrics['daysInService'], 2),
                ...
                'Take Off - Total' => number_format($metrics['takeOffTotal'], 2),
                'Revenue Take Off' => number_format($metrics['revenueTakeOff'], 2),
                ...
                'Technical Delay - Total' => number_format($metrics['technicalDelayTotal'], 2),
