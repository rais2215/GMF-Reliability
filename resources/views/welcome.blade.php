...
<head>
    ...
    <style>
        ...
        * {
        ...
        .loader-bar { animation: loader-bounce 1.4s infinite ease-in-out; }
        .loader-delay-1 { animation-delay: 0.16s; }
        .loader-delay-2 { animation-delay: 0.32s; }
        .progress-bar { animation: progress-fill 3s ease-in-out infinite; }
        .btn-primary {
        ...
        .swiper-progress { transition: width 0.5s ease; }
        .current-slide {
            color: #7EBB1A;
            font-weight: bold;
        }
        ...
        @media (max-width: 1280px) {
            .section-wrapper > div { margin-left: 0 !important; }
            .swiper.mySwiper { margin-left: 0 !important; }
        }
        ...
        @media (max-width: 900px) {
            .section-wrapper { align-items: flex-start; justify-content: flex-start; }
            .content-container { min-height: 500px !important; }
        }
        @media (max-width: 768px) {
            .hero-title { font-size: 2.2rem !important; }
            .section-wrapper { position: static; min-height: unset; }
            .content-container { min-height: 400px !important; }
            .swiper.mySwiper { height: 350px !important; }
            nav { padding: 1rem !important; }
        }
        @media (max-width: 640px) {
            .hero-title { font-size: 1.5rem !important; }
            .w-full.max-w-lg { margin-left: 0 !important; }
            .swiper.mySwiper { height: 260px !important; }
        ...
        @media (max-width: 500px) {
            ...
            .swiper.mySwiper { height: 180px !important; }
        }
        @media (max-width: 1024px) {
            .flex-row.lg\:flex-row { flex-direction: column !important; }
        }
    </style>
</head>
<body class="bg-[#112955] text-white font-sans min-h-screen h-full overflow-x-hidden relative flex flex-col lg:flex-row" x-data="{
    showLogin: false,
    currentSlide: 0,
    ...
    <nav class="absolute top-0 left-0 right-0 z-30 p-6">
        <div class="container mx-auto flex justify-between items-center">
            <div class="page-element delay-100">
                <img src="{{ asset('images/gmfwhite.png') }}" alt="GMF Logo" class="h-16 lg:h-20 w-auto hover:scale-110 transition-transform duration-300 drop-shadow-2xl">
            </div>
        </div>
    </nav>
    <div class="flex flex-col lg:flex-row w-full h-full min-h-screen">
        <!-- LEFT CONTENT SECTION -->
        <div class="w-full lg:w-1/2 flex flex-col justify-center h-full p-4 lg:p-8 min-h-screen lg:min-h-0">
            <div class="relative h-full flex items-center justify-center content-container min-h-[600px] sm:min-h-[700px] py-8 sm:py-0">
                <!-- Welcome Section -->
                <div
                    x-show="!showLogin"
        ...
        <div class="w-full lg:w-1/2 h-full px-4 lg:px-8 py-8 items-center justify-center flex-col page-element delay-400 flex">
            <div class="swiper mySwiper w-full max-w-2xl relative flex-shrink-0 lg:ml-8 mx-auto" style="height: 520px;">
                        ...
                        <div class="feature-card w-full max-w-lg space-y-6 bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-[#7EBB1A]/30 transition-all duration-500 mx-auto">
                            <div class="relative group mx-auto">
                                ...
                                <div class="relative h-48 lg:h-56 flex items-center justify-center mb-6 overflow-hidden rounded-2xl bg-white/5">
                                    <img src="{{ asset('images/hangar.png') }}" alt="Airplane Maintenance" class="max-w-full max-h-full object-contain rounded-xl shadow-xl transform group-hover:scale-105 transition-transform duration-500">
                                </div>
                            </div>
                            <div class="space-y-5 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#7EBB1A] leading-tight">Reliability Report System</h2>
                                </div>
                    ...
                    <div class="swiper-slide flex items-center justify-center text-center px-4">
                        <div class="feature-card w-full max-w-lg space-y-6 bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-[#7EBB1A]/30 transition-all duration-500 mx-auto">
                            <div class="relative group mx-auto">
                                <div class="absolute inset-0 bg-[#7EBB1A]/20 rounded-2xl blur-xl animate-pulse group-hover:bg-[#7EBB1A]/30 transition-all duration-500"></div>
                                <div class="relative h-48 lg:h-56 flex items-center justify-center mb-6 overflow-hidden rounded-2xl bg-white/5">
                                    <img src="{{ asset('images/hangar1.png') }}" alt="Data Analytics" class="max-w-full max-h-full object-contain rounded-xl shadow-xl transform group-hover:scale-105 transition-transform duration-500">
                                </div>
                            </div>
                            <div class="space-y-5 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#7EBB1A] leading-tight">Maintenance Insight</h2>
                                </div>
                                <p class="text-base text-gray-300 leading-relaxed max-w-md mx-auto">
                    ...
                    <div class="swiper-slide flex items-center justify-center text-center px-4">
                        <div class="feature-card w-full max-w-lg space-y-6 bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-[#7EBB1A]/30 transition-all duration-500 mx-auto">
                            <div class="relative group mx-auto">
                                <div class="absolute inset-0 bg-[#7EBB1A]/20 rounded-2xl blur-xl animate-pulse group-hover:bg-[#7EBB1A]/30 transition-all duration-500"></div>
                                <div class="relative h-48 lg:h-56 flex items-center justify-center mb-6 overflow-hidden rounded-2xl bg-white/5">
                                    <img src="{{ asset('images/hangar2.png') }}" alt="Collaboration" class="max-w-full max-h-full object-contain rounded-xl shadow-xl transform group-hover:scale-105 transition-transform duration-500">
                                </div>
                            </div>
                            <div class="space-y-5 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#7EBB1A] leading-tight">Progress & Corrective Actions</h2>
                                </div>
                                <p class="text-base text-gray-300 leading-relaxed max-w-md mx-auto">
                    ...
                    <div class="swiper-slide flex items-center justify-center text-center px-4">
                        <div class="feature-card w-full max-w-lg space-y-6 bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-[#7EBB1A]/30 transition-all duration-500 mx-auto">
                            <div class="relative group mx-auto">
                                <div class="absolute inset-0 bg-[#7EBB1A]/20 rounded-2xl blur-xl animate-pulse group-hover:bg-[#7EBB1A]/30 transition-all duration-500"></div>
                                <div class="relative h-48 lg:h-56 flex items-center justify-center mb-6 overflow-hidden rounded-2xl bg-white/5">
                                    <img src="{{ asset('images/hangar3.png') }}" alt="Risk Analysis" class="max-w-full max-h-full object-contain rounded-xl shadow-xl transform group-hover:scale-105 transition-transform duration-500">
                                </div>
                            </div>
                            <div class="space-y-5 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#7EBB1A] leading-tight">Trends & Risk Analysis</h2>
                                </div>
                                <p class="text-base text-gray-300 leading-relaxed max-w-md mx-auto">
