<h1 class="text-3xl font-bold mb-8 text-center text-white">Cumulative Flight Hours and Take Off</h1>

<div class="container mx-auto px-4">
    <form action="{{ url('/report/cumulative') }}" method="POST" class="bg-white p-6 rounded-xl shadow-md">
        @csrf
...
<script>
    // Perbaiki ID selector yang salah
            ...
            fetch(`/get-aircraft-types?operator=${operator}`)
                ...
                .then(data => {
                    data.forEach(type => {
                        ...
                        option.value = type.ACTYPE; // Sesuaikan dengan data dari controller
