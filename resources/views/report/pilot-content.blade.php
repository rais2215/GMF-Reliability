<h2 class="text-2xl md:text-3xl font-extrabold text-white mb-8 text-center animate-fade-in-up">Aircraft Operation Summary & Pilot Report And Technical Delay</h2>

<form id="pilot-form" action="{{ url('/report/pilot') }}" method="POST" class="bg-white p-8 rounded-3xl shadow-2xl border backdrop-blur-md animate-fade-in-up delay-100">
    @csrf
